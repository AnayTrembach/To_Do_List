class Todo {
  ...
  render() {
    ...
    <input type="checkbox" ${isChecked ? 'checked' : ''} class="todo-item__checkbox" id="${id}" data-js-todo-item-checkbox>
  ...
  addItem(title) {
    this.state.items.push({id: crypto?.randomUUID() ?? Date.now().toString(),
    title,
    isChecked: false,
  })
  ...
  onDeleteAllButtonClick = () => {
    const isConfermed = confirm('Are you sure you want to delete all?')
